...
<div class="container">
    ...
    <div class="welcome-container">
        <h1 class="heading-secondary">مرحبا بعودتك <span class="lg">{{($setting->title) ?? 'تطبيق الفلتر'}}</span></h1>
        <img src="{{asset('uploads/log.gif')}}" alt="login" style="max-height: 500px;mix-blend-mode: multiply">
    </div>
</div>
